...
- [Basic agent](https://github.com/microsoft-foundry/foundry-samples/tree/d268eada402bd5a16002a882e20bf4f969d78b9a/samples/python/hosted-agents/agent-framework/responses/01-basic/) — minimal agent with no tools
- [Connect to MCP servers](https://github.com/microsoft-foundry/foundry-samples/tree/d268eada402bd5a16002a882e20bf4f969d78b9a/samples/python/hosted-agents/agent-framework/responses/03-mcp/) — sample using remote MCP tool providers
- [Use Foundry Toolbox](https://github.com/microsoft-foundry/foundry-samples/tree/d268eada402bd5a16002a882e20bf4f969d78b9a/samples/python/hosted-agents/agent-framework/responses/04-foundry-toolbox/) — sample with Azure Foundry Toolbox integration
